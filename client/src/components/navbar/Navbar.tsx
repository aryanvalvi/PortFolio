...
const Navbar = () => {
  ...
  const authItems: NavItem[] = isCheckingSession
    ? []
    : user
      ? [
          {
  ...
  const renderDesktopItem = (item: NavItem) => {
    const sharedClasses =
      "relative px-2 py-1 text-sm dark:text-white cursor-pointer"
  ...
  return (
    <Container className="relative">
      ...
      >
        {/* <h1>ARYAN VALVI.</h1> */}
        <button
          className="absolute hidden md:block md:top-5.5 md:right-82 z-50 "
